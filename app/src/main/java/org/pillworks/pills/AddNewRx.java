...
public class AddNewRx extends AppCompatActivity {
    ...
    public void takePicture(View view) {
        ...
        if(intent.resolveActivity(getPackageManager()) != null) {
            String imageFilePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Pill/pill.jpg";
            imageFile = new File(imageFilePath);
            file = FileProvider.getUriForFile(AddNewRx.this, BuildConfig.APPLICATION_ID + ".provider", imageFile);
